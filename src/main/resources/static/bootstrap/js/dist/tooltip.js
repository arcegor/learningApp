...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@popperjs/core'), require('static/bootstrap/js/dist/util'), require('static/bootstrap/js/dist/util/sanitizer'), require('static/bootstrap/js/dist/dom/event-handler'), require('static/bootstrap/js/dist/dom/manipulator'), require('static/bootstrap/js/dist/base-component'), require('static/bootstrap/js/dist/util/template-factory')) :
  typeof define === 'function' && define.amd ? define(['@popperjs/core', 'static/bootstrap/js/dist/util', './util/sanitizer', './dom/event-handler', './dom/manipulator', './base-component', './util/template-factory'], factory) :
